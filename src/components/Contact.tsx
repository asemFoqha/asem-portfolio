...
const Contact = () => {
  ...
  const handelSubimt = (e: FormEvent) => {
    e.preventDefault();
    toast.success(
      "thanks " + contact.username + ", your message has been submited 😍"
    );
        ...
        <div className="contact-content">
          <div data-aos="flip-left" className="contact-left">
            ...
            <p>
              ...
              Dignissimos minus quasi sunt, ratione eaque eligendi delectus.
              Impedit minus laborum, eligendi et modi vel asperiores consectetur
              eius amet illum
            </p>
